...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Course Detail");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/add-icon.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     conn=dbfile.java_db();
          ...
          cs4=jTextField5.getText().toString();
           try{
                String reg= "insert into aizazcourse (stdid,coursename,coursename1,coursename2,coursename3) values ('"+id+"','"+cs1+"','"+cs2+"','"+cs3+"','"+cs4+"')";
